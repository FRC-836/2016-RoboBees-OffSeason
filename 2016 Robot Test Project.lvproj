...
<Project Type="Project" LVVersion="15008000">
	...
	<Property Name="varPersistentID:{01CAB0C4-BD52-4099-9E18-33F01367B743}" Type="Ref">/Target/Shared.lvlib/Distance Remaining</Property>
	<Property Name="varPersistentID:{030140C0-E966-4513-9DBC-9F6064A79355}" Type="Ref">/Target/Shared.lvlib/Auto Variables/Auto Starting Position</Property>
	<Property Name="varPersistentID:{034554DD-BD9E-42A6-AD15-F32C0408B277}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/Rockwall Enc</Property>
	<Property Name="varPersistentID:{034C7BF2-9D27-48ED-8027-46713CA31A73}" Type="Ref">/Target/Auto QCP Variables.lvlib/Rally Pt/Rally Pt 5 X</Property>
	<Property Name="varPersistentID:{03DDD18A-B5E6-470C-99C5-EEB14633B745}" Type="Ref">/Target/Vision Variables.lvlib/Right Target</Property>
	<Property Name="varPersistentID:{118C31DD-5B06-43B4-BCB6-2C6E869866F8}" Type="Ref">/Target/Shared.lvlib/Sensors/IMU Cal G</Property>
	<Property Name="varPersistentID:{17731341-9134-45CA-8F61-5237E841031B}" Type="Ref">/Target/Auto QCP Variables.lvlib/Turn and Score/Turn to Rally Pt Eval</Property>
	<Property Name="varPersistentID:{195877B6-F74B-4F6A-98B8-631422D98AB2}" Type="Ref">/Target/Auto QCP Variables.lvlib/Tower Locations/Tower Loc R Y</Property>
	<Property Name="varPersistentID:{19E1F4C8-0A79-4456-ACAE-189A6569DB43}" Type="Ref">/Target/Auto QCP Variables.lvlib/Rally Pt/Rally Pt 1 Y</Property>
	<Property Name="varPersistentID:{1B05A227-5382-424C-9B77-A4DF67E126D3}" Type="Ref">/Target/Auto QCP Variables.lvlib/Turn and Score/Turn to Rally Pt Tol</Property>
	<Property Name="varPersistentID:{1B87D6CE-15B9-4EB1-AFEA-BFB915979DEC}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/Moat Pitch</Property>
	<Property Name="varPersistentID:{1E3D1107-B92F-475C-A2D5-24189E273D74}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/Portcullis Enc</Property>
	<Property Name="varPersistentID:{1E88D7C4-85CA-4010-97B9-C21A4C92A258}" Type="Ref">/Target/Shared.lvlib/Auto Variables/Auto Goal Target</Property>
	<Property Name="varPersistentID:{2210F51F-0FBC-46C5-8A97-4D6A5AA9C9F4}" Type="Ref">/Target/Auto QCP Variables.lvlib/Rally Pt/Rally Pt 3 X L</Property>
	<Property Name="varPersistentID:{22DB3FEF-9DCC-4279-A352-95A6B557459F}" Type="Ref">/Target/Shared.lvlib/Auto Next State</Property>
	<Property Name="varPersistentID:{235393BA-C7F5-4121-B34C-0C4A8C6ADD2C}" Type="Ref">/Target/Auto QCP Variables.lvlib/Turn and Score/Tower Max Enc R</Property>
	<Property Name="varPersistentID:{24AAA918-5EF7-48F7-AB5E-40506200DD85}" Type="Ref">/Target/Auto QCP Variables.lvlib/Position Offsets/Position Offset_2</Property>
	<Property Name="varPersistentID:{24E94132-3785-4689-8C5F-823AA691E512}" Type="Ref">/Target/Shared.lvlib/Sensors/IMU Roll</Property>
	<Property Name="varPersistentID:{2AA5CF55-57AD-4F52-8D2D-5DB1EDF9D3FC}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/Rockwall Pitch T</Property>
	<Property Name="varPersistentID:{2F04CBA8-6F7A-47D3-B5F5-5D6FECA4C670}" Type="Ref">/Target/Shared.lvlib/Sonar</Property>
	<Property Name="varPersistentID:{30050FAE-9D2C-44DA-B1F4-B025EEFC9D5D}" Type="Ref">/Target/Auto QCP Variables.lvlib/Rally Pt/Rally Pt 2 Y R</Property>
	<Property Name="varPersistentID:{357456BB-D768-48E1-9E75-B61C3A10D609}" Type="Ref">/Target/Shared.lvlib/Controller Values/Intake Solenoid</Property>
	...
	<Property Name="varPersistentID:{445F7EE4-DAF8-4ECF-8F45-4BAC6FBFB8D1}" Type="Ref">/Target/Shared.lvlib/Auto Current State</Property>
	<Property Name="varPersistentID:{44E395AA-4073-449D-9367-5E155341AA5A}" Type="Ref">/Target/Shared.lvlib/Turn Hold Point</Property>
	<Property Name="varPersistentID:{48168B59-0492-433A-91FA-BC4EDBF8992E}" Type="Ref">/Target/Auto QCP Variables.lvlib/Tower Locations/Tower Loc R X</Property>
	<Property Name="varPersistentID:{49FA008A-DE34-406D-B0F5-B7FD8364DD7D}" Type="Ref">/Target/Auto QCP Variables.lvlib/Turn and Score/Turn to Tower Tol</Property>
	<Property Name="varPersistentID:{4AA37961-60C8-45D9-852D-F3F068E7070A}" Type="Ref">/Target/Shared.lvlib/Robot Mode</Property>
	<Property Name="varPersistentID:{4D9BAD02-1D21-420A-A331-2AE87463408A}" Type="Ref">/Target/Auto QCP Variables.lvlib/Tower Locations/Tower Loc L Y</Property>
	<Property Name="varPersistentID:{4F49852B-FBEE-4253-8101-67933E57400F}" Type="Ref">/Target/Auto QCP Variables.lvlib/Position Offsets/Position Offset_3</Property>
	<Property Name="varPersistentID:{5015DA21-3392-46FF-A9F4-67E4E82EEA8B}" Type="Ref">/Target/Auto QCP Variables.lvlib/Turn and Score/Camera Angle Good</Property>
	<Property Name="varPersistentID:{52A44EBA-5867-4353-B91B-6CEAA9BCE24D}" Type="Ref">/Target/Auto QCP Variables.lvlib/Rally Pt/Rally Pt 2 X L</Property>
	<Property Name="varPersistentID:{538E4605-0A00-42FE-B207-893957F841D4}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/Ramparts Pitch</Property>
	<Property Name="varPersistentID:{546918E1-ECC7-44B6-B716-76806CA68814}" Type="Ref">/Target/Auto QCP Variables.lvlib/Turn and Score/Turn to Tower Eval</Property>
	<Property Name="varPersistentID:{5A985467-24CD-4E71-A088-1665B5F13039}" Type="Ref">/Target/Auto QCP Variables.lvlib/Rally Pt/Rally Pt 3 Y R</Property>
	<Property Name="varPersistentID:{5ECB36D0-26B8-40A6-BBB6-13AF4F1674EA}" Type="Ref">/Target/Shared.lvlib/Tusks Notifier Typecast</Property>
	<Property Name="varPersistentID:{610ABFD0-3A6F-4664-907E-EB4F13A4D835}" Type="Ref">/Target/Shared.lvlib/Sensors/IMU Cal M</Property>
	<Property Name="varPersistentID:{611E2735-C8F8-4B70-B90D-FFD0636DAA5B}" Type="Ref">/Target/Shared.lvlib/Sensors/Left Encoder Distance</Property>
	<Property Name="varPersistentID:{62FCD575-F6E6-4E47-A099-869A1E1CE6F8}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/Rockwall Pitch</Property>
	<Property Name="varPersistentID:{650EEAF6-26B4-4011-AB53-2EF415EC4BD7}" Type="Ref">/Target/Vision Variables.lvlib/Valid</Property>
	<Property Name="varPersistentID:{6799D3A5-35E1-4758-8583-1520649850D1}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/Ramparts Offset</Property>
	<Property Name="varPersistentID:{67F1F72D-B4AC-4272-BEAD-79D755F226D3}" Type="Ref">/Target/Auto QCP Variables.lvlib/Turn and Score/Batter Pitch T</Property>
	<Property Name="varPersistentID:{68550590-16C7-4D90-A98C-4505D0E6C40F}" Type="Ref">/Target/Shared.lvlib/Turn Reinit</Property>
	<Property Name="varPersistentID:{68F2120A-6E02-4705-82F5-3F848A2A4119}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/Rough Terrain Enc</Property>
	<Property Name="varPersistentID:{6D7EF989-F81F-40B5-831D-7C5B804DC806}" Type="Ref">/Target/Shared.lvlib/Defense Crossed</Property>
	<Property Name="varPersistentID:{76A4614C-7FBD-44D2-9C4F-6E7A1E186E69}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/Ramparts Pitch T</Property>
	<Property Name="varPersistentID:{7ACF2893-3870-4A44-844F-DBBA870908D6}" Type="Ref">/Target/Vision Variables.lvlib/Left Target</Property>
	<Property Name="varPersistentID:{7CEA4A23-5E07-40C5-B343-1352FD1EE808}" Type="Ref">/Target/Auto QCP Variables.lvlib/Rally Pt/Rally Pt 4 Y L</Property>
	<Property Name="varPersistentID:{7E5B8E0B-A6FE-40FA-9B4D-7E11E7A4CB60}" Type="Ref">/Target/Vision Variables.lvlib/Target Angle</Property>
	<Property Name="varPersistentID:{7FD2E8E3-070E-40BA-837F-2995C0CC2763}" Type="Ref">/Target/Auto QCP Variables.lvlib/Position Offsets/Position Offset_5</Property>
	<Property Name="varPersistentID:{82D30CD7-3EC6-46F3-8D59-63ED581EEAF0}" Type="Ref">/Target/Shared.lvlib/Sensors/Encoder Distance</Property>
	<Property Name="varPersistentID:{84B79CF8-7056-4DAE-AAA1-0B2FBF5DE350}" Type="Ref">/Target/Shared.lvlib/Sensors/IMU Cal S</Property>
	<Property Name="varPersistentID:{85A663F4-57B3-4824-A9C5-ED2F7686CFD5}" Type="Ref">/Target/Auto QCP Variables.lvlib/Drive Forward Distances/Drive Forward Pos_3l</Property>
	<Property Name="varPersistentID:{87A69805-07F8-468D-8773-7786FE8340A5}" Type="Ref">/Target/Auto QCP Variables.lvlib/Rally Pt/Rally Pt 4 X R</Property>
	<Property Name="varPersistentID:{885302F2-3F4B-44EF-89E5-C7CB8C06D354}" Type="Ref">/Target/Shared.lvlib/Start Turn</Property>
	<Property Name="varPersistentID:{891688C9-5789-4DFE-8E55-46DA5792CF73}" Type="Ref">/Target/Shared.lvlib/Sensors/IMU Pitch</Property>
	<Property Name="varPersistentID:{8B7C085A-B63B-4581-AA11-094B8BE601AA}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/Moat Enc</Property>
	<Property Name="varPersistentID:{8F1638CD-39DF-48C6-B333-EB6BAC86851B}" Type="Ref">/Target/Shared.lvlib/AutoPeriodicCommands</Property>
	<Property Name="varPersistentID:{947F0161-790A-432F-A492-BFF5EB7B2014}" Type="Ref">/Target/Auto QCP Variables.lvlib/Drive Forward Distances/Drive Forward Pos_4r</Property>
	...
	<Property Name="varPersistentID:{A52545AE-481E-4ED5-BEF4-8915CBC276D2}" Type="Ref">/Target/Auto QCP Variables.lvlib/Rally Pt/Rally Pt 4 Y R</Property>
	<Property Name="varPersistentID:{A6392A9B-6569-4E7F-875E-386727A8A2EB}" Type="Ref">/Target/Auto QCP Variables.lvlib/Rally Pt/Rally Pt 5 Y</Property>
	<Property Name="varPersistentID:{ACEAC67D-C145-434B-8568-5F558857F421}" Type="Ref">/Target/Shared.lvlib/Sensors/Accel Z</Property>
	<Property Name="varPersistentID:{ADFB0829-F8B3-4658-9266-6053BE3C96BC}" Type="Ref">/Target/Shared.lvlib/Sensors/Boulder Detected</Property>
	<Property Name="varPersistentID:{B597F33A-3D51-4F37-A6F0-BD019176E0C5}" Type="Ref">/Target/Vision Variables.lvlib/Camera Delta</Property>
	<Property Name="varPersistentID:{B5981F3F-ED41-4990-A9F1-9B8CBC930699}" Type="Ref">/Target/Shared.lvlib/Intake Notifier Typecast</Property>
	...
	<Property Name="varPersistentID:{CA9F6298-3C54-4562-A4BC-909429AB2EEB}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/See Saw Enc</Property>
	<Property Name="varPersistentID:{D1A72596-47F5-47CB-97DE-D267FA068AFE}" Type="Ref">/Target/Auto QCP Variables.lvlib/Drive Forward Distances/Drive Forward Pos_2l</Property>
	<Property Name="varPersistentID:{D203B9DE-E865-4395-84B9-9C6949609F15}" Type="Ref">/Target/Shared.lvlib/Sensors/IMU Cal A</Property>
	<Property Name="varPersistentID:{D575A6C4-AEBE-4310-A762-3604CF7D1505}" Type="Ref">/Target/Shared.lvlib/DesiredAngle</Property>
	<Property Name="varPersistentID:{D8B5326E-9762-42F5-AC9B-D43AE0D3BF1D}" Type="Ref">/Target/Shared.lvlib/Sensors/Right Encoder Distance</Property>
	<Property Name="varPersistentID:{D94A30A0-68B1-4817-A7FB-A8EAE7C28F58}" Type="Ref">/Target/Shared.lvlib/Auto Variables/Tower Distance to Travel</Property>
	<Property Name="varPersistentID:{DA50F0A8-D99B-4F14-9B1C-A0032E232EF2}" Type="Ref">/Target/Shared.lvlib/Sensors/IMU Yaw</Property>
	<Property Name="varPersistentID:{DC34A32A-8BF8-4F2C-A246-199B0B910D27}" Type="Ref">/Target/Auto QCP Variables.lvlib/Defense Details/See Saw Offset</Property>
	<Property Name="varPersistentID:{E07C5768-8839-45E1-9936-9B32B0094A40}" Type="Ref">/Target/Auto QCP Variables.lvlib/Drive Forward Distances/Drive Forward Pos_3r</Property>
	<Property Name="varPersistentID:{E1B2F71E-C238-42C1-8623-852BF2C67EFE}" Type="Ref">/Target/Auto QCP Variables.lvlib/Drive Forward Distances/Drive Forward Pos_4l</Property>
	<Property Name="varPersistentID:{E97F278F-867A-4C08-BB8E-B13D40242D74}" Type="Ref">/Target/Auto QCP Variables.lvlib/Drive Forward Distances/Drive Forward Pos_2r</Property>
	<Property Name="varPersistentID:{EAC6584A-0242-4E38-8824-280BF10FB31F}" Type="Ref">/Target/Auto QCP Variables.lvlib/Drive Forward Distances/Drive Forward Pos_1l</Property>
	<Property Name="varPersistentID:{ED243E06-71B2-4E23-B9C9-6495D109211E}" Type="Ref">/Target/Auto QCP Variables.lvlib/Drive Forward Distances/Drive Forward Pos_5r</Property>
	<Property Name="varPersistentID:{EF51021F-5EFE-46FE-995B-67FDE13F8467}" Type="Ref">/Target/Shared.lvlib/Auto Variables/Auto Defense</Property>
	<Property Name="varPersistentID:{F04FC1AF-0936-4B33-AB0A-3062F680B9F3}" Type="Ref">/Target/Auto QCP Variables.lvlib/Turn and Score/Tower Min Enc L</Property>
	<Property Name="varPersistentID:{F10F88BE-936F-4BC5-9765-7B81D8F0F284}" Type="Ref">/Target/Auto QCP Variables.lvlib/Turn and Score/Camera Eval T</Property>
	<Property Name="varPersistentID:{F1954FED-55E1-477E-95B1-815CF832A2B2}" Type="Ref">/Target/Vision Variables.lvlib/Vision Status</Property>
	<Property Name="varPersistentID:{FB2BF4F5-1207-4EAB-9814-CB6FB11460A7}" Type="Ref">/Target/Auto QCP Variables.lvlib/Tower Locations/Tower Loc L X</Property>
	<Property Name="varPersistentID:{FD164BDF-1295-49EF-97E8-2EED7C362E09}" Type="Ref">/Target/Shared.lvlib/Auto State No Wait</Property>
	<Property Name="varPersistentID:{FDED5FEC-187E-413B-B4CB-F7C65B3BA382}" Type="Ref">/Target/Auto QCP Variables.lvlib/Rally Pt/Rally Pt 2 Y L</Property>
	<Property Name="varPersistentID:{FE60D6DA-EA51-43DC-A922-A5645FF63C6D}" Type="Ref">/Target/Auto QCP Variables.lvlib/Turn and Score/Camera Eval Thresh</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Support Code" Type="Folder">
			...
			<Item Name="Auto Control.ctl" Type="VI" URL="../Auto Control.ctl"/>
			<Item Name="De-Bounce or Delay.vi" Type="VI" URL="/&lt;userlib&gt;/836-Library/Logic/De-Bounce or Delay.vi"/>
			<Item Name="Motor Adjustment.vi" Type="VI" URL="../Motor Adjustment.vi"/>
			<Item Name="PeriodicTasksforSimulation.vi" Type="VI" URL="../DRIVING/PeriodicTasksforSimulation.vi"/>
			...
			<Item Name="LowBarStates.ctl" Type="VI" URL="../LowBarStates.ctl"/>
			<Item Name="Auto Rally Point Calculations.vi" Type="VI" URL="../Auto Rally Point Calculations.vi"/>
			<Item Name="Goal Selection.ctl" Type="VI" URL="../Goal Selection.ctl"/>
		</Item>
		<Item Name="Support Vision Code" Type="Folder" URL="../Support Vision Code">
		...
		<Item Name="Controls" Type="Folder">
			...
			<Item Name="Defense Position.ctl" Type="VI" URL="../Defense Position.ctl"/>
			<Item Name="Defenses.ctl" Type="VI" URL="../Defenses.ctl"/>
			<Item Name="DriveStates.ctl" Type="VI" URL="../DriveStates.ctl"/>
			<Item Name="DriveTypes.ctl" Type="VI" URL="../DriveTypes.ctl"/>
			<Item Name="ApproachTowerStates.ctl" Type="VI" URL="../ApproachTowerStates.ctl"/>
		</Item>
		...
		<Item Name="PID Constants.ctl" Type="VI" URL="../PID Constants.ctl"/>
		<Item Name="Camera Open.vi" Type="VI" URL="../836 Multi Camera Code/Camera Open.vi"/>
		<Item Name="Send 2 PC.vi" Type="VI" URL="../836 Multi Camera Code/Send 2 PC.vi"/>
		<Item Name="Get Image.vi" Type="VI" URL="../836 Multi Camera Code/Get Image.vi"/>
		<Item Name="Change Camera Configuration.vi" Type="VI" URL="../836 Multi Camera Code/Change Camera Configuration.vi"/>
		<Item Name="836_CameraIsCameraRefUSBAddress.vi" Type="VI" URL="../836 Multi Camera Code/836_CameraIsCameraRefUSBAddress.vi"/>
		<Item Name="IMUOrientOpenWithRST.vi" Type="VI" URL="../IMU/IMUOrientOpenWithRST.vi"/>
		<Item Name="Auto 2 Control.ctl" Type="VI" URL="../Auto 2 Control.ctl"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="user.lib" Type="Folder">
				...
				<Item Name="QCP Set.vi" Type="VI" URL="/&lt;userlib&gt;/836-Library/System/QCP Set.vi"/>
				<Item Name="QCP_Get_DBL.vi" Type="VI" URL="/&lt;userlib&gt;/836-Library/System/QCP Support Code/QCP_Get_DBL.vi"/>
				<Item Name="QCP_Set_DBL.vi" Type="VI" URL="/&lt;userlib&gt;/836-Library/System/QCP Support Code/QCP_Set_DBL.vi"/>
				<Item Name="QCPFileRead.vi" Type="VI" URL="/&lt;userlib&gt;/836-Library/System/QCPFileRead.vi"/>
				<Item Name="QCPFileWrite.vi" Type="VI" URL="/&lt;userlib&gt;/836-Library/System/QCPFileWrite.vi"/>
				<Item Name="QCP Data Block.ctl" Type="VI" URL="/&lt;userlib&gt;/836-Library/System/QCP Support Code/QCP Data Block.ctl"/>
				<Item Name="QCP_Get_I32.vi" Type="VI" URL="/&lt;userlib&gt;/836-Library/System/QCP Support Code/QCP_Get_I32.vi"/>
			...
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="836_CameraStartStopCount.vi" Type="VI" URL="/&lt;vilib&gt;/Rock Robotics/WPI/Camera/USB Support/836_CameraStartStopCount.vi"/>
				...
				<Item Name="836_CameraIsUSBAddress.vi" Type="VI" URL="/&lt;vilib&gt;/Rock Robotics/WPI/Camera/USB Support/836_CameraIsUSBAddress.vi"/>
				...
				<Item Name="FPGA_DIOReadPulse.vi" Type="VI" URL="/&lt;vilib&gt;/Rock Robotics/SystemInterfaces/DIO/FPGA_DIOReadPulse.vi"/>
				<Item Name="WPI_DigitalModuleIsPulsing.vi" Type="VI" URL="/&lt;vilib&gt;/Rock Robotics/WPI/DigitalModule/WPI_DigitalModuleIsPulsing.vi"/>
				<Item Name="WPI_DigitalOutputIsPulsing.vi" Type="VI" URL="/&lt;vilib&gt;/Rock Robotics/WPI/DigitalOutput/WPI_DigitalOutputIsPulsing.vi"/>
			...
			<Item Name="IMUOrientGetSetRefNum.vi" Type="VI" URL="../IMU/IMUOrientGetSetRefNum.vi"/>
			<Item Name="IMUOrientOpen.vi" Type="VI" URL="../IMU/IMUOrientOpen.vi"/>
			<Item Name="IMUOrientRead.vi" Type="VI" URL="../IMU/IMUOrientRead.vi"/>
			<Item Name="IMUOrientRefNum Registry Get.vi" Type="VI" URL="../IMU/IMUOrientRefNum Registry Get.vi"/>
			<Item Name="IMUOrientRefNum Registry Set.vi" Type="VI" URL="../IMU/IMUOrientRefNum Registry Set.vi"/>
			<Item Name="JK Latch.vi" Type="VI" URL="../IMU/JK Latch.vi"/>
			...
			<Item Name="Sample And Hold.vi" Type="VI" URL="../DRIVING/Sample And Hold.vi"/>
			<Item Name="Setup State.ctl" Type="VI" URL="../IMU/Setup State.ctl"/>
			...
			<Item Name="836_CameraSend Image String To PC 1.0.0.0.vi" Type="VI" URL="../836 Multi Camera Code/836_CameraSend Image String To PC 1.0.0.0.vi"/>
			<Item Name="836_CameraConvert Version String to Header String.vi" Type="VI" URL="../836 Multi Camera Code/836_CameraConvert Version String to Header String.vi"/>
			<Item Name="Camera Data.ctl" Type="VI" URL="../836 Multi Camera Code/Camera Data.ctl"/>
			<Item Name="Camera Settings.ctl" Type="VI" URL="../836 Multi Camera Code/Camera Settings.ctl"/>
			<Item Name="Distance and Angle.vi" Type="VI" URL="../Distance and Angle.vi"/>
